...
public class FordFulkerson {
    ...
    private NetworkEdge[] edgeTo;    // edgeTo[v] = last edge on shortest residual s->v path
     ...
     */
    public FordFulkerson(ComputerNetwork G, int s, int t) {
        V = G.V();
        validate(s);
        validate(t);
    ...
    private boolean hasAugmentingPath(ComputerNetwork G, int s, int t) {
    ...
    private double excess(ComputerNetwork G, int v) {
        double excess = 0.0;
        for (NetworkEdge e : G.adj(v)) {
    ...
    // return excess flow at vertex v
    private boolean isFeasible(ComputerNetwork G, int s, int t) {
    ...
    // check optimality conditions
    private boolean check(ComputerNetwork G, int s, int t) {
